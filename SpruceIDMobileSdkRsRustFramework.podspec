Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                   ...
                   DESC
  spec.homepage     = "https://github.com/AffintiQuest/mobile-sdk-rs"
  ...
  spec.source = { :http => "https://github.com/AffinitiQuest/mobile-sdk-rs/releases/download/#{spec.version}/RustFramework.xcframework.zip" }
